  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <GovernmentAnalytics user={user} api={api} />}
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <GovernmentReports user={user} api={api} />}
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <GovernmentTemplates user={user} api={api} />}
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <GovernmentSettings user={user} api={api} />}
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <GovernmentPolicies user={user} api={api} />}
          </ProtectedRoute>
        }
      />
      ...
      <Route
        path="/government/flagging"
        element={
          <ProtectedRoute allowedRoles={["admin"]}>
            {({ user, api }) => <FlaggingRules user={user} api={api} />}
          </ProtectedRoute>
        }
      />
