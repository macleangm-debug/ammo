...
class TestAMMONewFeatures:
    ...
    def __init__(self, base_url="https://ammo-owners-registry.preview.emergentagent.com/api"):
        self.base_url = base_url
        self.frontend_url = "https://ammo-owners-registry.preview.emergentagent.com"
